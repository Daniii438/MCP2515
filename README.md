...
==============
MCP_CAN library v1.5 modified
Changed the CAN0.setMode(MCP_SLEEP) to actually work right away and send the controller to sleep.

Added CAN0.InitPinIOModes() to initialize digitalI/O
Added CAN0.digitalPinWrite(pin, state); writes to the output pins
Added CAN0.digitalPinRead(pin); to read the state of I/O pins
